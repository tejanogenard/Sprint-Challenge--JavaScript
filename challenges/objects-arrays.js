...
// tyrannosaurus, carnivorous, 7000kg, 12m, Late Cretaceous
  function tyrannosaurus(name, diet, weight, length, period){
         this.name = name,
         this.diet = diet,
         this.weight = weight,
         this.length = length,
...
function stegosaurus(name, diet, weight, length, period){
  this.name = name,
  this.diet = diet,
  this.weight = weight,
  this.length = length,
...
function velociraptor(name, diet, weight, length, period){
  this.name = name,
  this.diet = diet,
  this.weight = weight,
  this.length = length,
...
let displayNames = [];
  arr.forEach(name => {
    displayNames.push(`Name: ${animal_name}, Scientific Name: ${scientific_name}`)
  })
}
...
*/
function lowCase(arr){
let lowCaseAnimalNames = [];
lowCaseAnimalNames = arr
return lowCaseAnimalNames.map(animal => {
...
function population(arr){
  ...
  lowPopulationAnimals = arr.filter(animal => {
...
populationTotal = arr.reduce(function(acc, nextItem){
  return acc + nextItem.population
})
}
